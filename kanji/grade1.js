...
const GRADE1_KANJI = [
    // --- 数字 ---
    { kanji: "一", readings: ["いち", "ひと(つ)"], meaning: "かず の 1", strokes: 1, example: "一つ ください", hint: "よこ の ぼう 1ぽん", example_reading: ["ひと"] },
    { kanji: "二", readings: ["に", "ふた(つ)"], meaning: "かず の 2", strokes: 2, example: "二人 で あそぶ", hint: "よこ の ぼう 2ほん", example_reading: ["ふた"] },
    { kanji: "三", readings: ["さん", "み(つ)"], meaning: "かず の 3", strokes: 3, example: "三びき の こぶた", hint: "よこ の ぼう 3ぼん", example_reading: ["さん"] },
    { kanji: "四", readings: ["し", "よ(つ)"], meaning: "かず の 4", strokes: 5, example: "四じ に かえる", hint: "くちの なかに ハが はいっている", example_reading: ["よ"] },
    { kanji: "五", readings: ["ご", "いつ(つ)"], meaning: "かず の 5", strokes: 4, example: "五つ かぞえる", hint: "うえ と した に よこぼう", example_reading: ["いつ"] },
    { kanji: "六", readings: ["ろく", "む(つ)"], meaning: "かず の 6", strokes: 4, example: "六月 は雨が多い", hint: "なべ の したに ハ", example_reading: ["ろく"] },
    { kanji: "七", readings: ["しち", "なな(つ)"], meaning: "かず の 7", strokes: 2, example: "七ならべ をする", hint: "カタカナ の ヒ みたい", example_reading: ["なな"] },
    { kanji: "八", readings: ["はち", "や(つ)"], meaning: "かず の 8", strokes: 2, example: "八百屋さん", hint: "ハ の かたち", example_reading: ["や"] },
    { kanji: "九", readings: ["きゅう", "ここの(つ)"], meaning: "かず の 9", strokes: 2, example: "九じ にねる", hint: "カタカナ の ノ と し", example_reading: ["く"] },
    { kanji: "十", readings: ["じゅう", "とお"], meaning: "かず の 10", strokes: 2, example: "十円 をひろう", hint: "たて と よこ の ぼう", example_reading: ["じゅう"] },
    { kanji: "百", readings: ["ひゃく"], meaning: "かず の 100", strokes: 6, example: "百てん をとる", hint: "一 の した に 白", example_reading: ["ひゃく"] },
    ...
    { kanji: "川", readings: ["かわ", "セン"], meaning: "みず がながれる ところ", strokes: 3, example: "川 であそぶ", hint: "みず がながれる ように 3ぼん", example_reading: ["かわ"] },
    { kanji: "森", readings: ["もり", "シン"], meaning: "きがたくさん", strokes: 12, example: "森 の くまさん", hint: "木 が 3つ あつまった", example_reading: ["もり"] },
    { kanji: "林", readings: ["はやし", "リン"], meaning: "きがならんでいるところ", strokes: 8, example: "林 のなか をさんぽ", hint: "木 が 2つ ならんでいる", example_reading: ["はやし"] },
    { kanji: "木", readings: ["き", "モク"], meaning: "えだやはがある しょくぶつ", strokes: 4, example: "大きな 木 にのぼる", hint: "十 の した に ハ", example_reading: ["き"] },
    ...
    { kanji: "空", readings: ["そら", "クウ"], meaning: "うえに ひろがる あおい ところ", strokes: 8, example: "空 がきれい", hint: "あなかんむり に エ", example_reading: ["そら"] },
    ...
    // --- 方向・位置 ---
    { kanji: "上", readings: ["うえ", "ジョウ"], meaning: "たかいほう", strokes: 3, example: "上 をみる", hint: "よこぼうの うえ にたてぼう", example_reading: ["うえ"] },
    ...
    // --- 日・時間 ---
    { kanji: "日", readings: ["ひ", "ニチ"], meaning: "たいよう、ひにち", strokes: 4, example: "日 ようび", hint: "おひさま の かたち", example_reading: ["にち"] },
    ...
    { kanji: "石", readings: ["いし", "セキ"], meaning: "かたい もの", strokes: 5, example: "石 をひろう", hint: "一 の した に 口", example_reading: ["いし"] },
    ...
    { kanji: "女", readings: ["おんな", "ジョ"], meaning: "おんなの ひと", strokes: 3, example: "女 のこ がわらう", hint: "くの じ と ノ", example_reading: ["おんな"] },
    { kanji: "男", readings: ["おとこ", "ダン"], meaning: "おとこの ひと", strokes: 7, example: "男 のこ がはしる", hint: "田 の した に 力", example_reading: ["おとこ"] },
    ...
    { kanji: "字", readings: ["じ", "ジ"], meaning: "もじ", strokes: 6, example: "字 をかく", hint: "うかんむり に 子", example_reading: ["じ"] },
    { kanji: "文", readings: ["ぶん", "モン"], meaning: "ぶんしょう", strokes: 4, example: "文 をかく", hint: "なべぶた に メ", example_reading: ["ぶん"] },
    { kanji: "本", readings: ["もと", "ホン"], meaning: "ほん、もとの", strokes: 5, example: "本 をよむ", hint: "木 の したに よこぼう", example_reading: ["ほん"] },
    { kanji: "名", readings: ["な", "メイ"], meaning: "なまえ", strokes: 6, example: "名前 をかく", hint: "夕 と 口 のくみあわせ", example_reading: ["な"] },
    ...
    // --- 動物・虫 ---
    { kanji: "犬", readings: ["いぬ", "ケン"], meaning: "ワンワン なくどうぶつ", strokes: 4, example: "犬 をかう", hint: "大 に てん がついた", example_reading: ["いぬ"] },
    ...
    // --- 音・王 ---
    { kanji: "音", readings: ["おと", "オン"], meaning: "きこえるもの", strokes: 9, example: "音 がする", hint: "立 と 日 のくみあわせ", example_reading: ["おと"] },
    ...
    { kanji: "町", readings: ["まち", "チョウ"], meaning: "ひとがすむ ところ", strokes: 7, example: "町 をさんぽ", hint: "田 に ちょう", example_reading: ["まち"] },
    { kanji: "村", readings: ["むら", "ソン"], meaning: "ちいさい まち", strokes: 7, example: "村 のおまつり", hint: "きへん に すん", example_reading: ["むら"] },
    { kanji: "車", readings: ["くるま", "シャ"], meaning: "タイヤがある のりもの", strokes: 7, example: "車 にのる", hint: "くるま を うえからみた かたち", example_reading: ["くるま"] },
];